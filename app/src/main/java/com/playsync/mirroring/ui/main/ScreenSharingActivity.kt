...
import com.playsync.mirroring.data.service.ScreenSharingForegroundService
import com.playsync.mirroring.data.service.StartForegroundServiceCallback
...
//    }
    ...
    private fun generateScreenSharingCode() {
        afterDelay(1000) {
            binding.pleaseWaitConstraint.gone()
        }
