package com.playsync.mirroring.data.service
...
import com.playsync.mirroring.ui.main.ScreenSharingActivity
import com.twilio.video.Room

class ScreenSharingForegroundService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val generateCodeIntent = Intent(this, ScreenSharingActivity::class.java)
        val pendingIntent =
